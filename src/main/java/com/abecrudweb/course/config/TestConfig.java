package com.abecrudweb.course.config;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		categoryRepostory.saveAll(Arrays.asList(cat1, cat2, cat3));
